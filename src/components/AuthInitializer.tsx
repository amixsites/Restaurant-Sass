      ...
      try {
        ...
        if (profileError) {
          ...
          if (profileError.code === 'PGRST116') {
            alert('Your user account exists in authentication, but has no profile in the "users" database table. Please ensure your user profile was created correctly in the public.users table.');
