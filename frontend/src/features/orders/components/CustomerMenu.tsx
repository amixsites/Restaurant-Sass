...
import { Search, ArrowLeft, ShoppingBag, Plus, Minus, LayoutGrid, List, User, Phone, Hash, ArrowRight, ChefHat, Loader2 } from 'lucide-react';
...
export const CustomerMenu = () => {
  ...
  // Fetch table details to get Table Number
  useEffect(() => {
    if (!tableId) return;
    ...
    const fetchTable = async () => {
      ...
      try {
        const { data: tableData, error } = await supabase
          ...
          .eq('id', tableId)
          .single();
        if (!error && tableData?.table_number) {
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar px-6 pt-10 pb-32">
          ...
          <div className="flex items-center justify-between mb-10">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="font-extrabold text-lg leading-tight">DineSwift</div>
    ...
    <MobileShell>
      ...
      <div className="px-5 pt-6 pb-3 bg-background sticky top-0 z-20">
        <div className="flex items-center justify-between mb-3">
          ...
          <button 
            onClick={() => navigate(`/m/${restaurantId}/${tableId}/cart`)} 
